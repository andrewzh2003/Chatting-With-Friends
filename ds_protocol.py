...
class unconnectableServer(Exception):
  pass
...
DataTuple = namedtuple('DataTuple', ['type','message', 'messages'])
...
def extract_json(json_msg:str) -> DataTuple:
  ...
  return DataTuple(type,message, messages)
